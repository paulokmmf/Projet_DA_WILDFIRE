...
if menu_id == "Introduction":
    ...
    st.write("Actions préparatoires :
-          Suppression valeurs manquantes et doublons
-          Renommage et création de nouvelles colonnes pour fusion avec d’autres jeux de données
-          Découpage des jours en jour « week end » et « hors week end »
-          Classement des causes de feu en 4 catégories :
o   Cause criminelle
o   Cause Accidentelle
o   Cause Naturelle
o   Autre cause
-          Transformation des systèmes métrique :
o   Surface de feux ( de km2 en ares)
o   Les précipitations (de cm en inch)
o   Les températures ( de degrés Celsius en Fahrenheit)
            Enrichissement du jeu de données avec des informations complémentaires obtenues en contactant via un formulaire
            sur le site https://www.noaa.gov/")    
